...
% Fault-detection of software components in robots is difficult problem.
% It is simultaneously becoming more difficult as the complexity of
% cognitive robots and the human-robot interaction increases.
