...
*** COMMENT Non-connected components
#+begin_src dot :exports none :file "img/10x0.pdf" :cache yes
  graph G {
          A;
          B; C; D; E; F; G; H; I; J;
...
#+results[e12770e1913edc49ff97a14d956f8a319dd77a5a]:
[[file:img/10x0.pdf]]
*** COMMENT dora experiment
*** COMMENT ROC analysis of the three approaches
* Project management
