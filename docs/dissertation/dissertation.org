...
#+LATEX_HEADER: \title{Probabilistic Models for Fault Detection in Event-Based Robotics Middlewares}
#+LATEX_HEADER: \author{Jeremiah M. Via}
#+LATEX_HEADER: \Keywords{robotics, machine learning, fault detection}
#+LaTeX_CLASS: article
...
the robot \cite{Golombek:2010hj}. 
