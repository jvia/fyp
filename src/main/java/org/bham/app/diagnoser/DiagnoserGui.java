...
public class DiagnoserGui extends javax.swing.JFrame {
    ...
    public void registerPresentable(Presentable newPresentable) {
        ...
        newPresentable.getPanel().setBorder(BorderFactory.createTitledBorder(
                BorderFactory.createEtchedBorder(),
                newPresentable.getPanel().getName()));
        presentablesTabbedPane.addTab(newPresentable.getPanel().getName(),
                newPresentable.getPanel());
    ...
    private void customizeComponents() {
        ...
        JFreeChart frequencyChart = ChartFactory.createXYLineChart("", "", "",
                new XYSeriesCollection(this.frequencySeries),
        ...
        frequencyPlotToCustomize.getRenderer().setSeriesStroke(0,
    ...
    private void initComponents() {
        ...
        presentablesTabbedPane.setPreferredSize(
                new java.awt.Dimension(750, 200));
        getContentPane().add(presentablesTabbedPane,
            ...
            java.awt.EventQueue.invokeLater(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        gui.registerPresentable(new T2GramModelTrainer(
                                new T2GramModelImp(new KDEProbabilityFactory())));
                        T2GramDetector t2gdetector = new T2GramDetector();
                        gui.registerPresentable(t2gdetector);
                        gui.registerPresentable(
                                new ClassifierOptimizer(t2gdetector));
                        gui.registerPresentable(
                                new T2GramVisualizer(t2gdetector));
                        gui.setVisible(true);
                    } catch (SecurityException exception) {
                        exception.printStackTrace();
                    } catch (IllegalArgumentException exception) {
