...
public class RingBuffer<T> {
    ...
    /**
     * returns an array with elements of the buffer. If the buffer is full, the
     * array has length getCapacity(), otherwise the array's length  is
     * the number of inserted elements.
     *
     * @return an array with elements of the buffer
     */
    @SuppressWarnings("unchecked")
