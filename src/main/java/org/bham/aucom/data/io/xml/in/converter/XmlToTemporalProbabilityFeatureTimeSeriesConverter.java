...
public class XmlToTemporalProbabilityFeatureTimeSeriesConverter extends XmlToTimeSeriesConverter<TemporalProbabilityFeature> {
    ...
    @Override
    public TimeSeries<TemporalProbabilityFeature> createTimeSeries(UUID id, UUID generatorID, UUID generatedFromID, ArrayList<TemporalProbabilityFeature> items) {
