...
abstract public class AbstractDetector implements Detector, Presentable {
    ...
    /**
     * add a status listener to the detector. listener will be notified when the
    ...
    /**
     * removes a specific listener from this object. no more notification will be
     * sent to the removed listener
     */
    @Override
    ...
    /**
     * Returns a default detector panel. It allows basic interaction with the
     * detector.
     */
