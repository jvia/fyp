...
public class ClassificationTimeSeriesDescriptiveStatisticsTest {
    ...
    public TimeSeries<Classification> getTimeSeriesWithFalseAlarm() {
        ...
        cl.setTimestamp(0);
        cl.setValue(0.5);
        cl.addAttribute(StatisticalAnomalyClassifier.THRESHOLD_USED, "0.4");
        cl.setNormal();
        clTs.add(cl);
        cl = Classification.createRandomClassification();
        cl.setTimestamp(2);
        cl.setValue(0.4);
        cl.addAttribute(StatisticalAnomalyClassifier.THRESHOLD_USED, "0.3");
        cl.setNormal();
        clTs.add(cl);
        cl = Classification.createRandomClassification();
        cl.setTimestamp(4);
        ...
        cl.setTimestamp(8);
        cl.setValue(0.1);
        cl.addAttribute(StatisticalAnomalyClassifier.THRESHOLD_USED, "0.0");
        cl.setNormal();
        clTs.add(cl);
        ...
        cl.setAbnormal();
        cl.setValue(0.0);
        cl.addAttribute(StatisticalAnomalyClassifier.THRESHOLD_USED, "0.6");
        clTs.add(cl);
        cl = Classification.createRandomClassification();
        cl.setTimestamp(12);
        cl.setValue(0.1);
