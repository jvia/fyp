...
public class TimeSeriesToXmlDocumentConverterTest {
    ...
    public void testConvertTimeSeries() {
        ...
        TimeSeries<AbstractData> timeSeriesToWrite = null;
    ...
    /**
     * Test of appendElementContentAsXml method, of class
     * TimeSeriesToXmlDocumentConverter.
     */
    @Test
    ...
    public class TimeSeriesToXmlDocumentConverterImpl extends TimeSeriesToXmlDocumentConverter<AbstractData> {

        public void appendElementContentAsXml(Element e, AbstractData data) {
        }
    }
}
