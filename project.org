...
- Mention CAST and give a brief overview of how it works, perhaps
  ...
  dissertation scope).
** Original system:
- the idea (just mention because it should be explained in the
  background),
- the implementation, and
- the experimental results.
- Asymptotic analysis as motivation for my extension.
** Connection-based model
- the idea (perhaps mentioning how it could be done on CAST with
    Jen's software) and
- the implementation.
- Show improved asymptotic analysis and
- lead into the disappointing results.
** Metronome-based approach
- the idea (showing a simple worked example),
- the implementation, and
