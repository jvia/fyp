...
public class ClassifierOptimizer implements Presentable, GraphStatusListener {
    ...
    private void prepareNextAnomalyClassifier() {
        optimizationMethod.getTestedClassifiers().put(this.optimizationMethod.getCurrentClassifier().duplicate(), optimizationMethod.getStatistic().getAnomalyValuePercent());
    ...
    public JPanel getPanel() {
        ...
        p.setPreferredSize(new Dimension(Constants.DEFAULT_PRESENTABLE_WIDTH, 100));
        return p;
    }
