...
public class TestData {
    ...
    public TestData(File in, File mfile, File out) {
        ...
        // .extract(in));
        // graph = new Graph().getConnector(new
        // ObservableQueueSource<RawData>(list, TEST_SOURCE)).
        // connect(new ClassifyRawData(new BasicClassifier(new
        // File("/home/rgolombe/classes2.txt")))).
        ...
        // connect(new OutputStreamSinkStrip(new
        // FileOutputStream(out))).getGraph();
        //
