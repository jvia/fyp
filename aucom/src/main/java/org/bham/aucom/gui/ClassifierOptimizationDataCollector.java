...
public class ClassifierOptimizationDataCollector implements TimeSeriesStatusListener {
	...
	public ClassifierOptimizationDataCollector(int inNumRequiredElements, boolean inIsStopAutomatically) {
		this(inNumRequiredElements);
		this.isStopAutomatically = inIsStopAutomatically;
	}

	public void start(TimeSeries<? extends Score> inTimeSeriesToCollectFrom) {
		if (this.isOptimizing) {
			// ignore
		} else {
			timseriesToCollectFrom = inTimeSeriesToCollectFrom;
