...
public class AddAttributeToElement extends AbstractAucomTransformNode<Observation, Observation> {

    final private ArrayList<Attribute> attributesToAdd = new ArrayList<Attribute>();
    ...
    /**
     * @param attr The attributes which will be added to the next xom.Element which will be piped through this node.
     */
