...
public class TemporalDurationFeature extends DataType {
	 ...
	 * 
	 * @param tdf
	 *            the object from which information is take in order to create a
	 ...
	 * durations. See @predecessorIdToDurationsMapping for an explanation of
	 * durations.
	 */
	...
	/**
     * Returns a list of {@link DataType} Objects which are the predecessors of the DataType represented by this object.
     * The order is given by the order the predecessors were added to this TemporalDurationFeature object.
     * @return
     */
	...
	/**
	 * Returns a list of data type ids of last predecessors of the DataType represented by this object.
	 * The order is given by the order the predecessors were added to this TemporalDurationFeature object.
	 * @return
	 */
