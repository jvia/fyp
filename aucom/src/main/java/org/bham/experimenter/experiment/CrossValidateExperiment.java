...
public class CrossValidateExperiment implements Experiment {
     ...
     * If a timestamp of a fault is set as attribute in the observation time-series the descriptive statistics is computed for the two parts of the time-series after being splitted based on the timestamp into
