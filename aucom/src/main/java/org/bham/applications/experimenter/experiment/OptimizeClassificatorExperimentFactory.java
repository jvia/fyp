...
public class OptimizeClassificatorExperimentFactory extends ExperimentFactory {
    ...
    public Experiment createExperiment(Element experimentDescription) throws ValidityException, ParsingException, IOException {
        ...
        OptimizeClassificatorExperiment experiment = null;
        ...
        try {
            ...
            experiment = new OptimizeClassificatorExperiment(detector, testDataIds, validationDataIds, name);
