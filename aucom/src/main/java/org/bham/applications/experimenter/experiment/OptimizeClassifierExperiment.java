...
public class OptimizeClassifierExperiment implements Experiment {
    ...
    public OptimizeClassifierExperiment(T2GramDetector inDetector, LinkedList<UUID> inTestTimeSeriesIds, LinkedList<UUID> inValidationTimeSeriesIds, String inName) {
        optimizer = new ClassifierOptimizer(inDetector);
